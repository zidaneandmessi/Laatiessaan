...
#     assert_compile_error var-semcheck.mx
...
#     assert_compile_error textwrite.mx
# }
...
#     assert_ok ./for-break
#     assert_compile_error break-semcheck.mx

#     assert_ok ./while-continue
#     assert_ok ./dowhile-continue
#     assert_ok ./for-continue
#     assert_compile_error continue-semcheck.mx
# }
...
#     assert_compile_success mdarray2.mx &&
#     if ruby_exists
#     then
...
#     assert_compile_error aref-semcheck.mx
#     assert_compile_error aref-semcheck2.mx
#     assert_compile_error array-semcheck1.mx
#     assert_compile_error array-semcheck2.mx
# }
...
#     assert_compile_success empstruct.mx
#     assert_compile_error struct-semcheck2.mx
#     assert_compile_error struct-semcheck3.mx
#     assert_compile_error struct-semcheck4.mx
#     assert_compile_error struct-semcheck5.mx
#     assert_compile_error struct-semcheck6.mx
#     assert_compile_error struct-semcheck7.mx
#     assert_compile_error struct-semcheck8.mx
#     assert_compile_error struct-semcheck9.mx
#     assert_compile_error struct-semcheck10.mx
# }

# test_20_union() {
#     assert_out "1;2;513" ./union   # little endian
#     assert_stat 0 ./union-semcheck
#     assert_compile_error union-semcheck2.mx
#     assert_compile_error union-semcheck3.mx
#     assert_compile_error union-semcheck4.mx
#     assert_compile_error union-semcheck5.mx
#     assert_compile_error union-semcheck6.mx
#     assert_compile_error union-semcheck7.mx
#     assert_compile_error union-semcheck8.mx
#     assert_compile_error union-semcheck9.mx
#     assert_compile_error union-semcheck10.mx
# }

# test_21_typedef() {
#     assert_out "1;2;1;1;3;4;5;6;OK" ./usertype
#     assert_compile_error recursivetypedef.mx
# }
...
#     assert_compile_error deref-semcheck1.mx
#     assert_compile_error deref-semcheck2.mx
#     assert_compile_error deref-semcheck3.mx
#     assert_compile_error deref-semcheck4.mx
#     assert_compile_error deref-semcheck5.mx
# }
...
#     assert_compile_error decloverride2.mx
# }

# test_26_funcptr() {
#     assert_out "OK;OK;OK;OK" ./funcptr
#     assert_out ";OK;OK;OK;OK;OK" ./implicitaddr
#     assert_compile_error defun-semcheck.mx
#     assert_compile_error defun-semcheck2.mx
#     assert_compile_error defun-semcheck3.mx
#     assert_compile_error defun-semcheck4.mx
#     assert_compile_error defun-semcheck5.mx
#     assert_compile_error defun-semcheck6.mx
#     assert_compile_error defun-semcheck7.mx
#     assert_compile_error defun-semcheck8.mx
#     assert_compile_error funcall-semcheck.mx
#     assert_compile_error funcall-semcheck2.mx
# }

# test_27_switch() {
#     if assert_compile_success switch.mx
#     then
...
#     assert_compile_success syntax2.mx
#     assert_stat 0 ./syntax3
# }

# test_29_import() {
#     assert_compile_success duplicated-import.mx
#     assert_compile_success vardecl.mx &&
#     assert_status 0 ./vardecl
#     assert_compile_success -fPIC vardecl.mx &&
#     assert_status 0 ./vardecl
# }

# test_30_staticfunction() {
#     assert_compile_success staticfunc.mx &&
...
#     assert_compile_success src1.mx src2.mx -o src &&
#     assert_status 4 ./src
# }
...
# test_35_invalidstmt() {
#     assert_compile_error invalidstmt1.mx
#     assert_compile_error invalidstmt2.mx
#     assert_compile_success validstmt1.mx
# }

# test_36_alloca() {
#     assert_out "<<Hello>>" ./alloca
#     assert_out "17;17;17;17" ./alloca2
#     assert_compile_success -fPIE -pie alloca2.mx &&
#     assert_out "17;17;17;17" ./alloca2
# }
...
assert_out() {
    ...
    then
        ...
        assert_compile_success "$1.mx" &&
        assert_stdout "$msg" "$@" &&
        assert_compile_success -O "$1.mx" &&
        assert_stdout "$msg" "$@" &&
        assert_compile_success -fPIC "$1.mx" &&
        assert_stdout "$msg" "$@" &&
        assert_compile_success -O -fPIC "$1.mx" &&
        assert_stdout "$msg" "$@"
    fi
}
...
assert_compile_error() {
    ...
    if egrep -qv 'mxc: (error|warning): ' tc.out
    then
        echo "shunit[$@]: abnormal mxc error; error message is:"
        cat tc.out
        shunit_test_failed
        return 1
    fi
