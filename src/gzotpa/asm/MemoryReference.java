...
public class MemoryReference extends Operand {
    ...
    public MemoryReference(long offset, Register base) {
        this(new IntegerLiteral(offset), base, true);
    }

    public MemoryReference(long offset, Register base, boolean fixed) {
        this(new IntegerLiteral(offset), base, fixed);
    }

    private MemoryReference(IntegerLiteral offset, Register base, boolean fixed) {
        this.offset = offset;
        this.base = base;
        this.fixed = fixed;
    }
